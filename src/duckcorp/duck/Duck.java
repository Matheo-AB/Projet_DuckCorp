 ...
 *
 * TODO (Ex1) :
 *   - Faites implémenter l'interface Qualifiable à cette classe -> OK
 *   - Implémentez equals() et hashCode() basés uniquement sur l'id -> OK
 *   - Implémentez les méthodes abstraites dans les sous-classes -> OK
