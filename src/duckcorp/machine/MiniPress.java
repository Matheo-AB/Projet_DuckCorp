 ...
 *
 * TODO (Ex2) :
 *   - Faites hériter cette classe de Machine -> OK
 *   - Implémentez le constructeur sans paramètre avec un appel à super -> OK
 *   - Implémentez produceDuck(), getPurchaseCost(), getName()  -> OK
